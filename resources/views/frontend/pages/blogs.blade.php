...
@section('content')
<div class="banner banner-cat" style="background-image: url('/frontend/images/banners/banner-top.jpg');"></div>
                ...
                <div class="entry-media">
                    <a href="single.html">
                        <div class="entry-slider owl-carousel owl-theme">
                            <img src="{{ asset('/frontend/images/blog/post-1.jpg') }}" alt="Post">
                            <img src="{{ asset('/frontend/images/blog/post-2.jpg') }}" alt="Post">
                            <img src="{{ asset('/frontend/images/blog/post-3.jpg') }}" alt="Post">
