                                    ...
                                    <div class="row" id="product-data">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                                            <div class="ps-product">
                                                ...
                                                <div class="ps-product__container"><a class="ps-product__vendor" href="#">{{ $product_list->productCategory->name }}</a>
                                ...
                                <div class="ps-product ps-product--wide">
                                        ...
                                        <div class="ps-product__container">
                                            <div class="ps-product__content"><a class="ps-product__title" href="{{ route('single-product', $product_list->slug) }}">{{ $product_list->name }}</a>
                                                ...
                                                <p class="ps-product__vendor">Category:<a href="#">{{ $product_list->productCategory->name }}</a></p>
